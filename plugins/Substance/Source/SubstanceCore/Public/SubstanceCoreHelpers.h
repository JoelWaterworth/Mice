...
SUBSTANCECORE_API void RenderAsync(TArray<SubstanceAir::GraphInstance*>&);
SUBSTANCECORE_API void RenderAsync(SubstanceAir::GraphInstance*);

/** Perform a blocking rendering of those instances */
SUBSTANCECORE_API void RenderSync(TArray<SubstanceAir::GraphInstance*>&);
SUBSTANCECORE_API void RenderSync(SubstanceAir::GraphInstance*);
...
SUBSTANCECORE_API void PushDelayedImageInput(SubstanceAir::InputInstanceImage* ImgInput, SubstanceAir::GraphInstance* Instance);
...
SUBSTANCECORE_API void CreatePlaceHolderMips(SubstanceAir::GraphInstance* Instance);
...
SUBSTANCECORE_API void EnableTexture(SubstanceAir::OutputInstance* Output, USubstanceGraphInstance* Graph);
...
SUBSTANCECORE_API bool UpdateTextures(TArray<SubstanceAir::GraphInstance*>& Instances);
SUBSTANCECORE_API bool UpdateTextures(SubstanceAir::GraphInstance* Instance);
...
SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const SubstanceAir::InputInstanceBase* InputInstance, class UObject* InValue);
SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const SubstanceAir::InputInstanceBase* InputInstance, const FString& InValue);
SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const SubstanceAir::InputInstanceBase* InputInstance, const TArray<int32>& InValue);
SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const SubstanceAir::InputInstanceBase* InputInstance, const TArray<float>& InValue);
...
const SubstanceAir::GraphDesc* FindParentGraph(const std::vector<SubstanceAir::GraphDesc>& Graphs, SubstanceAir::GraphInstance*);
...
SubstanceAir::shared_ptr<SubstanceAir::InputImage> PrepareImageInput(class UObject* InValue,
        SubstanceAir::InputInstanceImage* Input, SubstanceAir::GraphInstance* Parent);
...
void SetImageInput(SubstanceAir::InputInstanceImage* Input, UObject* InValue, SubstanceAir::GraphInstance* Parent,
...
SUBSTANCECORE_API SubstanceAir::PackageDesc* InstantiatePackage(void* assemData, uint32 size);

/** Assigns a graph instance input deltas to the preset passed in */
SUBSTANCECORE_API void CopyPresetData(SubstanceAir::GraphInstance* Source, SubstanceAir::Preset& Dest);
...
SUBSTANCECORE_API void ApplyPresetData(SubstanceAir::GraphInstance* Destination, SubstanceAir::Preset& Source);
