...
struct OutputDesc
{
	...
	//! @brief Output usage enumeration or Channel_UNKNOWN if user specific 
	ChannelUse mChannel;
	
	//! @brief Channel usage string
	//! Useful if mChannel is Channel_UNKNOWN: user specific syntax.
	string mChannelStr;
